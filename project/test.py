...
class AllTests(unittest.TestCase):
    ...
    def test_user_regsitration_error(self):
    ...
    def test_logged_in_users_can_logout(self):
        self.register('Fletcher','fletcher@realpyton.com','python101','python101')
    ...
    def create_user(selfself, name, email, password):
    ...
    def test_users_can_can_add_tasks(self):
        self.create_user('Michael', 'michael@realpython.com', 'python')
        self.login('Michael', 'python')
        self.app.get('tasks/', follow_redirects=True)
        response = self.create_task()
        self.assertIn(
            b'New entry was succesfully posted. Thanks', response.data
        )
    ...
    def test_users_can_complete_tasks(self):
        self.create_user('Michael', 'michael@realpyton.com','python')
        self.login('Michael', 'python')
        self.app.get('tasks/', follow_redirects=True)
        self.create_task()
